...
INSERT INTO memos (title, content, category, tags) VALUES
('첫 번째 메모', '이것은 첫 번째 테스트 메모입니다.', 'personal', ARRAY['테스트', '샘플']),
('업무 메모', '프로젝트 일정을 확인해야 합니다.', 'work', ARRAY['업무', '일정']),
('학습 노트', 'Supabase와 Next.js 연동 방법을 배웠습니다.', 'study', ARRAY['supabase', 'nextjs']);